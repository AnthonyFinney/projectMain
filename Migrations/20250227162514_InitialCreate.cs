    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTemplateAccesses", x => new { x.UserId, x.TemplateId });
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserTemplateAccesses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FormQuestion", x => new { x.FormId, x.QuestionId });
                    table.ForeignKey(
                        name: "FK_FormQuestion_Forms_FormId",
                        column: x => x.FormId,
                        principalTable: "Forms",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FormQuestion_Questions_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Answers_FormQuestion_FormId_QuestionId",
                        columns: x => new { x.FormId, x.QuestionId },
                        principalTable: "FormQuestion",
                        principalColumns: new[] { "FormId", "QuestionId" });
                    table.ForeignKey(
